...
export const Button = ({
  ...
  const baseStyles =
    "w-full py-3 font-semibold rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-purple-300 disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer";
